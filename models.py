...
class Scan(Base):
    ...
    unit_price: Mapped[str | None] = mapped_column(String(255))
    discount_claim: Mapped[str | None] = mapped_column(String(255))
    free_qty_claim: Mapped[str | None] = mapped_column(String(255))
